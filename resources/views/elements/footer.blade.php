        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="about-widget">
                    <a title="Lipyum" class="navbar-brand" href="{{ route('home-page') }}" style="display: flex;align-items: center;justify-content: flex-start;margin-bottom: 1rem;">
            ...
            <div class="col-lg-2 offset-lg-2">
                <div class="location-widget">
                    <h4>Lipyum</h4>
                    <ul class="info">
                        <li><a title="Hakkımızda" href="{{ route('about') }}">Hakkımızda</a></li>
                        <li><a title="İletişim" href="{{ route('contact') }}">İletişim</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2">
                <div class="customer-care">
                    <h4>Politikalar</h4>
                    <ul class="info">
                        <li><a title="Gizlilik Politikası" href="{{ route('privacy-policy') }}">Gizlilik Politikası</a></li>
                        <li><a title="Çerez Politikası" href="{{ route('cookie-policy') }}">Çerez Politikası</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2">
                <div class="follow-us">
                    ...
                    <ul class="social-links">
                        <li>
                            <a title="Instagram" href="https://www.instagram.com/lipyumcom">
...
{{--                        <li>--}}
{{--                            <a title="Twitter" href="https://twitter.com/lipyum">--}}
...
{{--                        </li>--}}
{{--                        <li>--}}
{{--                            <a title="LinkedIn" href="https://linkedin.com/in/lipyum">--}}
{{--                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"--}}
...
{{--                        </li>--}}
                        <li>
                            <a title="Facebook" href="https://www.facebook.com/Lipyum-108092095240439">
