<section class="what-they-say" style="margin: 10rem 0;">
                        ...
                        <div class="col-lg-12"> {{-- if(bg-image === true) ? col-lg-7 : col-lg-12 --}}
                            <div id="owl-what-they-say" class="owl-what-they-say owl-carousel owl-loaded owl-drag">
                                <div class="owl-stage-outer">
                                    <div class="owl-stage"
                                         style="transform: translate3d(-727px, 0px, 0px); transition: all 0.25s ease 0s; width: 2545px;">
                                        <div class="owl-item cloned" style="width: 333.5px; margin-right: 30px;">
                                        ...
                                        <div class="owl-item active" style="width: 333.5px; margin-right: 30px;">
                                            <div class="item testimonial-item">
                                                <img class="float-start" src="assets/images/" alt="">
                                                <div class="icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44"
                                        ...
                                        <div class="owl-item" style="width: 333.5px; margin-right: 30px;">
                                            <div class="item testimonial-item">
                                                <img class="float-start" src="assets/images/" alt="">
                                                <div class="icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44"
