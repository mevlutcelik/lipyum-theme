        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="left-image">
                    <img src="{{ asset('images/explore-work-left-image.jpg') }}" alt="Interior Design Work">
                </div>
            </div>
            <div class="col-lg-6">
                        ...
                        <li>
                            ...
                            <ul class="info">
                                ...
                                <li>
                                    ...
                                    <em>Designer HTML5 Template is 100% free to download provided by TemplateMo website.
                                    </em>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="info">
                                ...
                                <li>
                                    ...
                                    <em>This is based on latest Bootstrap v5.1.3 CSS layout where you can easily edit
                                        and use Bootstrap components.</em>
                                </li>
                            </ul>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <ul class="info">
                                ...
                                <li>
                                    ...
                                    <em>You are <strong>NOT allowed</strong> to redistribute the downloadable ZIP file
                                        of this template on any other website. Please contact us for more info.</em>
                                </li>
                            </ul>
                        </li>
                    </ul>
